...
#include <trading/logic/deal.hpp>
#include <trading/logic/default_storage.hpp>
#include <trading/logic/market_member.hpp>
#include <trading/logic/order.hpp>
#include <trading/logic/trading_platform.hpp>
...
class CommonForDefaultStorageTest : public testing::Test {
 protected:
  ...
  using DefaultStorageType = DefaultStorage<OrderType, DealType>;
  ...
  void SetUp() override {
    SegmentConfig<DefaultStorage> config(ioc_, ms_);
